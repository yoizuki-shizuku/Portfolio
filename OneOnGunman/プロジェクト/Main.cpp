...
LPCWSTR g_szAppName = L"OneOnGunman";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        HWND hwnd = CreateWindowExW(0, L"AnimationWindowClass", g_szAppName, WS_MY_WINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"AnimationWindowClass", g_szAppName, WS_POPUP,
    ...
    while (WM_QUIT != msg.message)
    {
        ...
        {
            g_game->Tick();
            //  終了フラグを受け取ったら、ゲームを終了させる
            if (g_game->GetExitGame()) break;
        }
    }
