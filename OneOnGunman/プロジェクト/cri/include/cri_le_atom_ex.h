...
#define CRIATOMEX_VER_NUM		"2.26.23"
#define CRIATOMEX_VER_MAJOR		(2)
#define CRIATOMEX_VER_MINOR		(26)
#define CRIATOMEX_VER_PATCH		(23)
 ...
 * \ingroup ATOMEXLIB_3D
 * \param[in]	ex_3d_listener			3Dリスナーハンドル
 * \param[out]	distance_focus_level	距離センサのフォーカスレベル
 * \par 説明:
 * 距離センサのフォーカスレベルを設定します。<br>
 ...
 * \ingroup ATOMEXLIB_3D
 * \param[in]	ex_3d_listener			3Dリスナーハンドル
 * \param[out]	direction_focus_level	方向センサのフォーカスレベル
 * \par 説明:
